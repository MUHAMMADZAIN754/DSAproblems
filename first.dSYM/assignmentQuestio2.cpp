...
size--;
cout<< "Array after deleting the first element is "<<endl;   
   for(int i=0;i<=size ; i++) 
{
...
cout<<" The sum of array after deleting the array element is" <<endl;
...
cout<< " Sum of elements of array after deleting the array element is "<< totalsum <<endl;
